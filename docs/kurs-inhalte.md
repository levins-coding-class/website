...
**Was ist das?**
Git ist wie eine Zeitmaschine für deinen Code! Du kannst:
...
**Was ist das?**
VS Code ist deine **Entwicklungsumgebung** (IDE). Das ist wie Microsoft Word, aber für Programmierer!
...
**Was ist das?**
Typst ist wie Word, aber du schreibst **Code**, um schöne Dokumente zu erstellen!
...
**Was ist das?**
React ist eine **JavaScript-Library** zum Erstellen von Websites und Apps! Damit wurden viele bekannte Websites gemacht (z.B. Facebook, Instagram).
...
**Was ist das?**
Astro ist ein modernes Tool, um **superschnelle Websites** zu erstellen!
